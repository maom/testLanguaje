<?php
session_start();
$referencia  = "TEST_ingles_instrucciones.php";
...
if (!strcmp($_SESSION['IDsess'], session_id()) && !empty($_SESSION['Sess_correo']) && $_SESSION['Sess_clave_test'] == 1) {
 ...
 if(isset($_POST['correo'])) {
  ...
  if (!empty($_POST['correo']) && !empty($_POST['clave'])) {
	...
	$RES = DBquery($SQL);
    if ($RES->numRows()) {
		$SQL_TEST = "SELECT * FROM TEST_RESPONDIDOS WHERE correo = '" . $_POST['correo'] . "' AND clave_test = '1'";
	    ...
	    if($RES_TES->numRows()){
			...
			$date =date('Y-m-d');
			$SQL_INSERT = "INSERT INTO TEST_RESPONDIDOS VALUES (NULL , '', '" . $date . "', '', '', '1', '" . $_POST['correo'] . "')";
			$RES_INSERT = DBquery($SQL_INSERT);
			$SQL_TEST_RES = "SELECT * FROM TEST_RESPONDIDOS WHERE correo = '" . $_POST['correo'] . "' and clave_test = '1'";
      ...
      $row = $RES->fetchRow();
        ...
        header("Location: $referencia");
         ...
         $mensaje = "La cuenta de correo electr&oacute;nico <br />o la clave de ingreso son incorrectas.";
    }
  } else {
      $mensaje = "Es necesario escribir su cuenta de correo electr&oacute;nico<br />y la clave de ingreso.";
  }
	} else {
        ...
        <td><table border="0" align="center" cellpadding="1" cellspacing="1" class="texto_verdana_11px_blanco">
          <form action="<?=$PHP_SELF?>" method="post" name="acceso">
            ...
            <tr>
              ...
              <td><input name="correo" type="text" class="texto_cajas" id="correo" value="<?=$_POST['correo']?>"></td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="2" class="texto_verdana_10px_gris" align="right"><a href="recupera_clave.php">Olvide mi contrase&ntilde;a</a><img src="img/pixel.gif" width="10" height="10" /></td>
            </tr>
            <tr>
              <td colspan="2" class="texto_verdana_10px_gris" align="right"><a href="registro.php">Registrarme</a><img src="img/pixel.gif" width="10" height="10" /></td>
            </tr>
            <tr>
              <td colspan="2" align="center"><input name="button" type="image" id="button" value="Submit" src="img/boton_entrar.png">              </td>
            </tr>
          </form>
        </table></td>
      </tr>
